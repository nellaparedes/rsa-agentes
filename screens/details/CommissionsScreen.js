          ...
          <View style={styles.contentComms}>
            ...
            <View style={styles.boxComms}>
              <View style={styles.infoComms}>
                ...
                <TextCatam font="bold" others={styles.textPaid}>
                  PAGADAS
                </TextCatam>
              </View>
              ...
              <View style={styles.infoComms}>
                ...
                <TextCatam font="bold" others={styles.textReceivable}>
                  POR COBRAR
                </TextCatam>
              </View>
            </View>
          ...
          <View style={styles.commsClient}>
            <View style={styles.col}>
              <View style={styles.row}>
                <TextCatam font="bold" others={styles.titleComsCli}>
                  Comisión por Cobrar
                </TextCatam>
              </View>
              <View style={styles.row}>
                <View style={styles.colCli}>
                  <TextCatam font="bold" others={styles.textTit}>
                    Cliente
                  </TextCatam>
                </View>
                ...
                renderItem={({ item }) => (
                  ...
                  >
                    <View style={styles.colCli}>
                      ...
                      <TextCatam others={{ fontSize: 9 }}>
                        {item.client}
                      </TextCatam>
                    </View>
                    <View style={styles.colVal}>
                      <TextCatam font="bold" others={{ fontSize: 10 }}>
                        $ {item.prima}
                      </TextCatam>
                    </View>
                    <View style={styles.colVal}>
