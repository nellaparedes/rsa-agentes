...
import { Platform, StatusBar, StyleSheet, FlatList, TouchableOpacity, View, ActivityIndicator } from 'react-native';
            ...
            <View style={styles.container}>
                ...
                >
                    ...
                    <View style={styles.title}>
                        <TextCatam font='bold' others={styles.textTitle}>{this.state.name}</TextCatam>
                    </View>
                </TouchableOpacity>
