        ...
        <ScrollView style={styles.contentContainer}>
          <View style={styles.contentBanner}>
            ...
            >
              <FontAwesomeIcon
                ...
                styles={{ fontSize: 30, color: Colors.greenDark }}
              />
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.contentCumpl}>
            <View style={styles.headerBox}>
              <TextCatam font="bold" others={styles.textHeader}>
                Cumplimiento Comercial
              </TextCatam>
              <TouchableOpacity
                onPress={() => this.props.navigation.navigate("Compliance")}
              >
                <TextCatam font="bold" others={styles.textHeader}>
                  MÁS
                </TextCatam>
            ...
            <View style={styles.boxCumpl}>
              <View style={styles.infoCumpl}>
                ...
                <View style={{ alignItems: "center" }}>
                  <TextCatam font="bold" others={styles.textPorcent}>
                    {this.state.sales}%
                  </TextCatam>
                  <TextCatam font="bold" others={styles.textSales}>
                    VENTAS
                  </TextCatam>
                </View>
              </View>
              ...
              <View style={styles.infoCumpl}>
                ...
                <View style={{ alignItems: "center" }}>
                  <TextCatam font="bold" others={styles.textPorcent}>
                    {this.state.renovations}%
                  </TextCatam>
                  <TextCatam font="bold" others={styles.textRenew}>
                    RENOVACIONES
                  </TextCatam>
                </View>
              </View>
          ...
          <View style={styles.contentComms}>
            ...
            <View style={styles.boxComms}>
              <View style={styles.infoComms}>
                <TextCatam font="bold" others={styles.valueComms}>
                  $ {this.state.comms_pay}
                </TextCatam>
                <TextCatam font="bold" others={styles.textSales}>
                  PAGADAS
                </TextCatam>
          ...
          <View style={styles.contentFolio}>
            <View style={styles.headerBox}>
              ...
              <TouchableOpacity
                onPress={() => this.props.navigation.navigate("Folio")}
              >
                <TextCatam font="bold" others={styles.textHeader}>
                  MÁS
                </TextCatam>
            ...
            <View style={styles.boxFolio}>
              <View style={styles.infoFolio}>
                ...
                />
                <TextCatam font="bold" others={styles.numberFolio}>
                  {this.state.clients_inter}
                </TextCatam>
                <TextCatam>Clientes</TextCatam>
                <TextCatam font="bold" others={styles.textFolio}>
                  AMV Internacional
                </TextCatam>
              </View>
              <View style={styles.infoFolio}>
            ...
            <View style={styles.boxFolio}>
              ...
              <View style={styles.footFolio}>
                ...
                <TextCatam font="bold" others={styles.primeFootFolio}>
                  $ {this.state.clients_prime}
                </TextCatam>
              </View>
            </View>
          </View>
          ...
          <View style={styles.contentClaims}>
            ...
            <View>
                ...
                <View style={styles.infoClaims}>
                  <View style={styles.colInfoClaims}>
                    <FontAwesomeIcon
                      ...
                      style={{ fontSize: 14 }}
                    />
                    <Text font="bold" style={{ fontSize: 12 }}>
                      {" "}
                      {this.state.claims_int}{" "}
                    </Text>
                    <TextCatam others={{ fontSize: 12 }}>
                      AMV Internacional
                    </TextCatam>
                  </View>
                  <View style={styles.colInfoClaims}>
              ...
              <View style={styles.footClaims}>
                ...
                <TextCatam font="bold" others={styles.valueReport}>
                  $ {this.state.claims_value}
                </TextCatam>
              </View>
            </View>
          </View>
          ...
          <View style={styles.contentEmerg}>
            ...
            <View style={styles.boxEmerg}>
              ...
              >
                ...
                <TextCatam others={{ fontSize: 12 }}>
                  {this.state.emrg_name_int}
                </TextCatam>
                <TextCatam font="bold" others={styles.numberEmerg}>
                  {this.state.emrg_num_int}
                </TextCatam>
              </TouchableOpacity>
              <TouchableOpacity
              ...
              >
                ...
                <TextCatam others={{ fontSize: 12 }}>
                  {this.state.emrg_name_loc}
                </TextCatam>
                <TextCatam font="bold" others={styles.numberEmerg}>
                  {this.state.emrg_num_loc}
                </TextCatam>
              </TouchableOpacity>
              <TouchableOpacity
              ...
              >
                ...
                <TextCatam others={{ fontSize: 12 }}>
                  {this.state.emrg_name_gen}
                </TextCatam>
                <TextCatam font="bold" others={styles.numberEmerg}>
                  {this.state.emrg_num_gen}
                </TextCatam>
              </TouchableOpacity>
            </View>
            ...
            >
              <View style={styles.questionsFoot}>
                ...
                <View style={styles.textQuestionFoot}>
                  <TextCatam font="bold" others={styles.textFootEmerg}>
                    PREGUNTAS FRECUENTES
                  </TextCatam>
                  <TextCatam others={{ fontSize: 12 }}>
                    {this.state.cont_question} artículos
                  </TextCatam>
                </View>
              </View>
